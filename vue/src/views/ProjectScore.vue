  ...
  <div>
    <div style="margin-bottom: 30px">
      <el-breadcrumb spearator="/">
        ...
        <el-breadcrumb-item>竞赛评分</el-breadcrumb-item>
...
<!--    <div style="margin: 10px 0"  >
    ...
    <el-table :data="tableData" border stripe :cell-style="cellStyle">
      ...
      <el-table-column prop="projectcondition" label="赛况" width="120"></el-table-column>
      <el-table-column prop="projectmember" label="竞赛成员" width="120"></el-table-column>
      <el-table-column prop="fileName" label="作品" width="100"></el-table-column>

      <el-table-column prop="score" label="评分" ></el-table-column>
      <el-table-column  label="操作">
        <template slot-scope="scope">
          <el-button @click="look(scope.row.url)" type="primary">
            查看作品
          </el-button>
